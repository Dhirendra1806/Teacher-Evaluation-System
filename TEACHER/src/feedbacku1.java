...
import java.sql.*;
public class feedbacku1 extends JFrame  implements ActionListener{
	...
	public feedbacku1() {
		...
		btn4 = new JButton("Feedback Record");
		btn4.setBounds(1800,10,150,50);
		btn4.addActionListener(this);
		//btn4 = new ImageIcon(getClass().getResource("bk3.png"));
		//btn4.setIcon((img4));
		l.add(btn4);
